...
struct NewsTickerSettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section {
                NavigationLink("Manage Countries") {
                    CountryManagerview()
                }
            }
        }
        .alert("Country Not Supported", isPresented: $showAlert) {
            ...
            Text("Currently, the API only supports 'United States'. Other countries will not display any headlines at the time of development.")
        }
